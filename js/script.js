...
$("#image-roon-1").hover(
    function(){  
        $(this).attr("src",'images/work/roon-parsonstypography.jpeg');  
    },
    function(){  
        $(this).attr("src", "images/work/roon-parsonstypography-pixel.png");  
    }, 
);
$("#image-roon-3").hover(
function(){  
    $(this).attr('src','images/work/Roon-googlefonts.png');  
},
function(){  
    $(this).attr("src", "images/work/roon-googlefonts-pixel.png");  
}, 
);
...
$("#image-seb-1").hover(
function(){  
    $(this).attr('src','images/work/seb-endangered.jpeg');  
},
function(){  
    $(this).attr("src", "images/work/seb-endangered-pixel.png");  
}, 
);
$("#image-seb-2").hover(
    function(){  
        $(this).attr('src','images/work/seb-overthere.jpeg');  
    },
    function(){  
        $(this).attr("src", "images/work/seb-overthere-pixel.png");  
    }, 
);
$("#image-seb-3").hover(
function(){  
    $(this).attr('src','images/work/seb-syllabic.png');  
},
function(){  
    $(this).attr("src", "images/work/seb-syllabic-pixel.png");  
}, 
);
